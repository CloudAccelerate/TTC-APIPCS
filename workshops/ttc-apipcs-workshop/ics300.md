...
### 1.4 Initial Re-Test the API with Policies
...
**1.5.3** Select the TestApp application and ensure that Registered is selected in the Select Initial State section.
