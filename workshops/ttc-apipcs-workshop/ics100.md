...
**2.5.4** Copy the URL from the page above https://ICS URL/integration/flowapi/rest/HELLOWORLD_USER01/v01/metadata, paste it into a browser to check if HelloWorldUserXX Integration Flow is working.
